...
impl From<u16> for ConsumerKey {
    fn from(value: u16) -> Self {
        match value {
            ...
            0x73 => Self::BrightnessMinimum,
            0x74 => Self::BrightnessMaximum,
            0x75 => Self::BrightnessAuto,
            0xB0 => Self::Play,
            0xB1 => Self::Pause,
            0xB2 => Self::Record,
...
impl From<ConsumerKey> for u16 {
    fn from(value: ConsumerKey) -> Self {
        match value {
            ...
            ConsumerKey::BrightnessMinimum => 0x73,
            ConsumerKey::BrightnessMaximum => 0x74,
            ConsumerKey::BrightnessAuto => 0x75,
...
impl ConsumerKey {
    ...
    pub fn to_hid_keycode(&self) -> Option<HidKeyCode> {
        match self {
            ...
            ConsumerKey::BrightnessMinimum => Some(HidKeyCode::BrightnessMinimum),
            ConsumerKey::BrightnessMaximum => Some(HidKeyCode::BrightnessMaximum),
            ConsumerKey::BrightnessAuto => Some(HidKeyCode::BrightnessAuto),

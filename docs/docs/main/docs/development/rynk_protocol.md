...
| `0x0305` | `GetComboDefinition`     | `u8`                            | `ComboDefinition`                |         | Read either an action- or position-triggered combo without changing the original `GetCombo` wire representation. |
| `0x0306` | `SetComboDefinition`     | `SetComboDefinitionRequest`     | `()`                             |         |                                                                                                                  |
| `0x0307` | `GetComboDefinitionBulk` | `GetComboBulkRequest`           | `GetComboDefinitionBulkResponse` |         |                                                                                                                  |
| `0x0308` | `SetComboDefinitionBulk` | `SetComboDefinitionBulkRequest` | `()`                             |         |                                                                                                                  |

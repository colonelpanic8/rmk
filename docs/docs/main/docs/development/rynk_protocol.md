...
| `0x0109` | `GetLayerMetadata`    | `u8`                      | `LayerMetadata`         |         | Read one fixed layer slot's persistent name and logical occupancy.           |
| `0x010A` | `SetLayerMetadata`    | `SetLayerMetadataRequest` | `()`                    |         | Rename, occupy, or vacate one fixed layer slot.                              |

...
| `0x000E` | `GetDeviceDataDescriptor` | `()`                   | `DeviceDataDescriptor`  |         | Describe the board-defined, machine-readable device-data namespace.          |
| `0x000F` | `GetDeviceDataRecord`     | `u8`                   | `DeviceDataRecord`      |         | Read one typed record from the board-defined device-data namespace.          |

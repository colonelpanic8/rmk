...
| `0x070D` | `GetAutoSwitchTransport` | `()`                   | `bool`                  | `_ble`  | Whether plugging or unplugging USB retargets the preferred transport.        |
| `0x070E` | `SetAutoSwitchTransport` | `bool`                 | `()`                    | `_ble`  | Persist the auto-switch policy; it applies from the next cable change.       |

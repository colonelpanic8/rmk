...
const SDC_MEM_SIZE: usize =
    5688 + rmk::types::constants::NUM_BLE_PROFILE.saturating_sub(1) * SDC_MEM_PER_ADDITIONAL_HOST;
const FLASH_START_ADDR: usize = 0x100000;
...
async fn main(spawner: Spawner) {
    info!("Hello RMK BLE on nRF54L15!");

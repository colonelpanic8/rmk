...
use rmk_types::protocol::rynk::{
    ...
    LayerState, LightingAdvancedRuntimeConditionalScenesPage, LightingCapabilities, LightingCompiledSceneStatus,
    ...
    LockStatus, MacroData, MaintenanceMode, MatrixState, MorseHoldTriggerPositionState, MorseProfileEntry,

...
pub static KEYCODE_ALIAS: Lazy<HashMap<&str, &str>> = Lazy::new(|| {
    ...
    add_alias!("CtrlGuiSwapToggle" = "cg_togg", "ctrl_gui_toggle", "ctrl_gui_tog");
    add_alias!("F1");
    add_alias!("F2");
    add_alias!("F3");
    add_alias!("F4");
    ...
    add_alias!("BrightnessMinimum" = "brightness_minimum", "brimn");
    add_alias!("BrightnessMaximum" = "brightness_maximum", "brimx");
    add_alias!("BrightnessAuto" = "brightness_auto", "bria");
